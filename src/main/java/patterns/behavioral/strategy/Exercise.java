...
class QuadraticEquationSolver
{
    ...
    public Pair<Complex, Complex> solve(double a, double b, double c)
    {
        ...
        Complex sqrt = Complex.sqrt(discriminant);
        Complex denominator = new Complex(2 * a, 0);
        Complex negB = new Complex(-b, 0);
        Complex left = negB.plus(sqrt);
        Complex right = negB.minus(sqrt);
        return new Pair<>(left.divides(denominator), right.divides(denominator));
    }
}
