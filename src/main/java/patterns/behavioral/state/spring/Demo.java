package patterns.behavioral.state.spring;
...
public class Demo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while (true) {
            ...
            System.out.printf("The phone is %s%n", state.getId());
            System.out.println("Select a trigger:");

            List<Transition<States, Events>> ts = machine
                    .getTransitions()
                    .stream()
            ...
            for (int i = 0; i < ts.size(); i++) {
                System.out.printf("%s. %s%n", i, ts.get(i).getTrigger().getEvent());
            }
            boolean parseOk;
            int choice = 0;
            do{
