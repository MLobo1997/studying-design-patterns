...
//You use decorators when you want to extend the functionality of an already existing class.
// Because you dont want to change the code (OCP)
//There are 2 ways to build decorator:
//1. by extending
//2. by reference. This is more necessary when the object is final, hence you cant extend it
...
class MagicString{
    ...
    //You dont need to do this for all methods.
    //public int lenght(){
...
class Demo{
    public static void main(String[] args) {
        MagicString str = new MagicString("hello");
        System.out.printf("%s has %s vowels", str, str.getNumberofVowels());
    }
}